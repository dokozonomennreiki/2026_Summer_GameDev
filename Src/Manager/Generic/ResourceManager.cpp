...
{
	Resource res;
	res = Resource(Resource::TYPE::MODEL, Application::PATH_MODEL + "Planet/MainPlanet.mv1");
...
void ResourceManager::ResourcePlayer(void)
{
	...
	// プレイヤーのモデル
	res = Resource(Resource::TYPE::MODEL, Application::PATH_MODEL + "Player/untitled.mv1");
...
void ResourceManager::ResourceEnemy(void)
{
	...
	// プレイヤーのモデル
	res = Resource(Resource::TYPE::MODEL, Application::PATH_MODEL + "Player/untitled.mv1");
	resourcesMap_.emplace(SRC::MODEL_ENEMY, res);
}

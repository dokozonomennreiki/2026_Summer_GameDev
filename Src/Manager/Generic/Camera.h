...
private:
    ...
    // カメラ設定関連
    static constexpr VECTOR DEFAULT_POS = { 0.0f, 600.0f, -1200.0f }; // 初期座標
    ...
    static constexpr float  DEFAULT_VERTICAL = 180.0f;                // 初期垂直角度（ピッチ）
    ...
    static constexpr VECTOR RELATIVE_F2C_POS_FOLLOW = { 0.0f, 300.0f, -1200.0f };  // 追従対象からのカメラオフセット

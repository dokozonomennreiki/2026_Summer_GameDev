...
private:
    ...
    bool CheckCircleVsBox(const ColliderBase* circle, const ColliderBase* box, CollisionInfo& outInfo);

    bool CheckBoxVsBox(const ColliderBase* colA, const ColliderBase* colB, CollisionInfo& outInfo);

    bool CheckCollision(const ColliderBase* colA, const ColliderBase* colB, CollisionInfo& outInfo);
